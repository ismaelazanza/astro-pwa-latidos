...
export const seoConfig = {
	baseURL: "https://radiolatidos893.com", // Change this to your production URL.
	description:
	...
	siteName: "Radio Latidos 89.3", // Change this to your website's name,
	twitter: {
...
export const manifest: Partial<ManifestOptions> = {
	name: "Radio Latidos 89.3", // Change this to your website's name.
	short_name: "Radio Latidos 89.3", // Change this to your website's short name.
	description:
